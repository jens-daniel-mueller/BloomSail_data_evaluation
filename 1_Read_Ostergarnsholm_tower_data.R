...
M6 <- read_csv(here::here("Data/Ostergarnsholm/Tower", "Oestergarnsholm_Atmospheric_data_2018_6.csv"))
M7 <- read_csv(here::here("Data/Ostergarnsholm/Tower", "Oestergarnsholm_Atmospheric_data_2018_7.csv"))
M8 <- read_csv(here::here("Data/Ostergarnsholm/Tower", "Oestergarnsholm_Atmospheric_data_2018_8.csv"))

df_old <- bind_rows(M6, M7, M8)
rm(M6, M7, M8)
...
df <- read_csv2(here::here("Data/Ostergarnsholm/Tower", "Oes_Jens_atm_water_June_to_August_2018.csv"))
